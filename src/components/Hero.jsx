...
const Hero = () => {
  ...
  return (
    ...
    <div className='container realtive' ref={parallaxRef}>
      <div className='relative z-1 max-w-[63rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]'>
        <h1 className='h1 mb-6'>
          Explore the Possibilities <br /> of AI Chatting With {` `}
          <span className='inline-block relative'>
            Brainwave 
            <img src={curve}
              className='absolute top-full left-0 xl:-mt-2 w-full'
              width={624} height={28}
              alt='Curve'  
            />
          </span>
      ...
      <div className='relative max-w-[23rem] mx-auto md:max-w-5xl xl:mb-24'>
        <div className='relative z-1 p-0.5 rounded-2xl '>
          <div className='relative bg-n-8 rounded-[1rem]'>
            ...
            <div className='aspect-[33/40] rounded-b-[0.9rem] overflow-hidden md:aspect-[688/490] lg:aspect-[1024/490]'>
              <img src={robot} className='w-full scale-[1.7] translate-y-[8%] md:scale-[1] md:-translate-y-[8%] lg:-translate-y-[18%]'
        ...
        <div className='absolute -top-[54%] left-1/2 w-[234%] -translate-x-1/2 md:-top-[46%] md:w-[138%] lg:-top-[104%]'>
          <img src={heroBackground} 
            className='w-full'
            width={1440} height={1800} alt='hero'
          />
        </div>
        <BackgroundCircles />           
      </div>
