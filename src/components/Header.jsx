      ...
      <div className="flex items-center px-5 lg:px-7.5 xl:px-10 max-lg:py-4">
        ...
        `}>
          <div className="relative z-2 flex flex-col items-center justify-center
            ...
            {navigation.map((item) => (
              <a key={item.id} href={item.url} onClick={handelClick}
              className={`block relative font-code text-3xl
        ...
        <a href="#singup" className="button hidden mr-8 text-n-1/60 transition-colors
         hover:text-n1 lg:block">
          New account
        </a>
        ...
        <Button className="ml-auto lg:hidden" px='px-3' onClick={taggleNavigation}>
